...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "calculadoragwt" because\n';
  ...
  $wnd.__gwt_activeModules['calculadoragwt'] = {
    'moduleName' : 'calculadoragwt',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/calculadoragwt.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['calculadoragwt'].superdevmode = true;

  var expectedSuffix = '/calculadoragwt.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + calculadoragwt + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:calculadoragwt';
  var devModeSessionKey = '__gwtDevModeSession:calculadoragwt';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/calculadoragwt/calculadoragwt.nocache.js';
  ...
  $wnd.__gwt_activeModules['calculadoragwt'].canRedirect = true;
  $wnd.__gwt_activeModules['calculadoragwt'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING calculadoragwt';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/calculadoragwt?user.agent=' + ua + '&_callback=' + callback;
